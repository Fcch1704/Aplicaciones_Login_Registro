 ...
 * @author fcch1
 */
@WebServlet(name = "ControladorAlumno_Notas", urlPatterns = {"/ControladorAlumno_Notas"})
public class ControladorAlumno_Notas extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Alumno_Curso> lista = dao.listarAlumnoCursos();
